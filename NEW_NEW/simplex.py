...
# Em simplex.py, dentro da classe SimplexSolver

    def add_constraint(self, coeffs: List[float], rhs: float):
        """
        Adiciona uma nova restrição de corte (na forma <=) ao tableau existente.
        """
        # Adiciona uma nova linha para a restrição e uma nova coluna para sua var de folga
        ...
        new_row[-2] = 1.0 # Nova variável de folga
        new_row[-1] = rhs
